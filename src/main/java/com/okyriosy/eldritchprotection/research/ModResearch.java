...
public final class ModResearch {
    ...
    public static void initResearch() {
        ...
        research = new FauxResearchItem(Reference.R_FAUX_SALTS,Reference.EP_CATEG,"BATHSALTS","ALCHEMY",0,0,getOriginalItem("BATHSALTS","ALCHEMY")).registerResearchItem();

        research = new TXResearchItem(Reference.R_INTRO,Reference.EP_CATEG, new AspectList().add(Aspect.SOUL, 2).add(Aspect.TAINT, 1).add(Aspect.HEAL, 2), 2, 0, 1,new ResourceLocation(Reference.MOD_ID, "textures/research/intro.png")).setParents(Reference.R_FAUX_SALTS).setParentsHidden("BATHSALTS").setConcealed().registerResearchItem();
...
//        research = new FauxResearchItem(Reference.R_FAUX_REVELATION,Reference.EP_CATEG,"ELDRITCHMAJOR","ELDRITCH",6,4,new ResourceLocation("thaumcraft", "textures/misc/r_eldritchmajor.png")).registerResearchItem();
...
//    	research.setPages(new ResearchPage("1"),new ResearchPage("2"),infusionPage("TRASHJAR"));
	...
	private static void registerResearchPages() {
		...
		ResearchCategories.registerCategory(Reference.EP_CATEG, new ResourceLocation(Reference.MOD_ID, "textures/items/scentedLocket.png"), background2);
